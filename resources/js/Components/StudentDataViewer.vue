        ...
        <v-window v-model="activeTab" class="pa-4 bg-white border border-t-0 rounded-b-lg">
            ...
            <v-window-item value="data_pribadi">
                <v-row dense>
                    ...
                    <v-col cols="12" md="4" class="text-grey-darken-1 font-weight-medium">NIK / KITAS</v-col>
                    ...
                    <v-col cols="12" md="4" class="text-grey-darken-1 font-weight-medium">Kebutuhan Khusus</v-col>
                    <v-col cols="12" md="8">: {{ s_add.special_needs || '-' }}</v-col>
                ...
                <v-row dense>
                    <v-col cols="12" md="6">
                        ...
                        <v-row dense>
                            ...
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Tahun Lahir</v-col><v-col cols="7">: {{ p_add.father_birth_year || '-' }}</v-col>
                            ...
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Penghasilan</v-col><v-col cols="7">: {{ p_add.father_income || '-' }}</v-col>
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Keb. Khusus</v-col><v-col cols="7">: {{ p_add.father_special_needs || '-' }}</v-col>
                        </v-row>
                    </v-col>
                    <v-col cols="12" md="6">
                        ...
                        <v-row dense>
                            ...
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Tahun Lahir</v-col><v-col cols="7">: {{ p_add.mother_birth_year || '-' }}</v-col>
                            ...
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Penghasilan</v-col><v-col cols="7">: {{ p_add.mother_income || '-' }}</v-col>
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Keb. Khusus</v-col><v-col cols="7">: {{ p_add.mother_special_needs || '-' }}</v-col>
                        </v-row>
                    </v-col>
                    <v-col cols="12" md="6" class="mt-4">
                        ...
                        <v-row dense>
                            ...
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Tahun Lahir</v-col><v-col cols="7">: {{ p_add.guardian_birth_year || '-' }}</v-col>
                            ...
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Penghasilan</v-col><v-col cols="7">: {{ p_add.guardian_income || '-' }}</v-col>
                        </v-row>
                    </v-col>
                    <v-col cols="12" md="6" class="mt-4">
                        <div class="text-subtitle-2 font-weight-bold text-primary mb-2 border-b pb-1">Kontak Keluarga</div>
                        <v-row dense>
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">No. Telepon / WA</v-col><v-col cols="7">: {{ pd.parent_phone || '-' }}</v-col>
                        </v-row>
                    </v-col>
                ...
                <v-row dense>
                    <v-col cols="12" md="6">
                        ...
                        <v-row dense>
                            ...
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Kabupaten Asal</v-col><v-col cols="7">: {{ r_add.school_city || '-' }}</v-col>
                    ...
                    <v-col cols="12" md="6">
                        ...
                        <v-row dense>
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Jenis Prestasi</v-col><v-col cols="7">: {{ s_add.achievement_type || '-' }}</v-col>
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Nama Prestasi</v-col><v-col cols="7">: {{ s_add.achievement_name || '-' }}</v-col>
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Tahun Prestasi</v-col><v-col cols="7">: {{ s_add.achievement_year || '-' }}</v-col>
                            <v-col cols="5" class="text-grey-darken-1 font-weight-medium">Penyelenggara</v-col><v-col cols="7">: {{ s_add.achievement_organizer || '-' }}</v-col>
                        </v-row>
                    </v-col>
                ...
                <v-row dense>
                    <v-col cols="12" md="6">
                        ...
                        <v-row dense>
                            ...
                            <v-col cols="6" class="text-grey-darken-1 font-weight-medium">Lingkar Kepala</v-col><v-col cols="6">: {{ s_add.head_circumference ? s_add.head_circumference + ' cm' : '-' }}</v-col>
                        </v-row>
                    </v-col>
                    <v-col cols="12" md="6">
