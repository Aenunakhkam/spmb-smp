...
<template>
    <div class="min-h-screen bg-slate-50 flex font-sans text-slate-800">
        ...
        <a v-if="$page.props.app_settings?.contact_whatsapp" :href="'https://wa.me/' + $page.props.app_settings?.contact_whatsapp.replace(/[^0-9]/g, '')" target="_blank" class="fixed bottom-[30px] right-[30px] bg-[#25d366] text-white w-[60px] h-[60px] rounded-full flex items-center justify-center shadow-[0_4px_15px_rgba(37,211,102,0.4)] z-[1000] hover:scale-110 transition-transform duration-300" title="Hubungi Admin / Support melalui WhatsApp">
